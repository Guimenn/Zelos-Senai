...
import { Input, Button, Checkbox, Card, CardBody, CardHeader, Chip } from "@heroui/react"
import { 
  FaEye, 
  FaEyeSlash, 
  FaUser, 
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <FaUser className="text-white/50 text-sm" />
              </div>
              <input
                type="text"
                ...
                placeholder="Usuário"
                disabled={isLoading}
                className={`w-full px-4 py-3 pl-10 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg text-white placeholder-white/40 focus:ring-1 focus:ring-red-400 focus:border-red-400 transition-all duration-200 text-sm ${errors.email ? 'border-red-400' : ''}`}
              />
              {errors.email && (
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <FaLock className="text-white/50 text-sm" />
              </div>
              <input
                ...
                placeholder="Senha"
                disabled={isLoading}
                className={`w-full px-4 py-3 pl-10 pr-10 bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg text-white placeholder-white/40 focus:ring-1 focus:ring-red-400 focus:border-red-400 transition-all duration-200 text-sm ${errors.password ? 'border-red-400' : ''}`}
              />
              <button
                type="button"
                onClick={handleTogglePasswordVisibility}
                disabled={isLoading}
                className="absolute inset-y-0 right-0 pr-3 flex items-center text-white/50 hover:text-white transition-colors cursor-pointer"
              >
